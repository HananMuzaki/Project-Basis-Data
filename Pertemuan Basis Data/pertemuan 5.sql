...
--Null Operator
select * from products where description in null;

select * from products where description in not null;
...
--String function
select id, nama, description from products;

select id, lower(nama), length(nama), lower(description) from products;
